...
(function (root, factory) {
  ...
  var CONDITIONS = {
    ...
    petrified: { id: 'petrified', name: 'Petrified', text: 'A petrified creature is transformed, along with any nonmagical objects it is wearing or carrying, into a solid inanimate substance (usually stone). Its weight increases by a factor of ten, and it ceases aging. The creature is incapacitated, can\'t move or speak, and is unaware of its surroundings. Attack rolls against the creature have advantage. The creature automatically fails Strength and Dexterity saving throws. The creature has resistance to all damage, and is immune to poison and disease, although a poison or disease already in its system is suspended, not neutralised.', effects: ['incapacitated', 'cant_move', 'cant_speak', 'auto_fail_str_dex_saves', 'unaware_of_surroundings', 'resist_all_damage', 'attacks_have_advantage'], endsOn: 'duration' },
